...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <section class="my-4">
                <div class="row">
                    <div class="col"><h4>{{ __('Edit Role Details') }}</h4></div>
                </div>
            </section>
            ...
            <section class="my-4">
                <form action="{{ route('roles.update', $role) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @if ($errors->has('name')) is-invalid @endif" type="text" name="name" value="{{ old('name', $role->name) }}" autofocus>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input  @if ($errors->has('has_all_permissions')) is-invalid @endif" id="has-all-permissions-checkbox" name="has_all_permissions" {{ old('has_all_permissions', $role->hasAllPermissions()) ? 'checked' : null }}>
                    ...
                    <div class="form-group" id="permissions-form-group">
                        ...
                        <div class="custom-control custom-checkbox">
                            @forelse ($permissions as $permission)
                                <div>
                                    <input type="checkbox" class="custom-control-input  @if ($errors->has('permissions')) is-invalid @endif" id="{{ $permission->id }}" name="permissions[]" value="{{ $permission->id }}"  {{ in_array($permission->id, $role->permissions->modelKeys()) ? 'checked' : null }}>
